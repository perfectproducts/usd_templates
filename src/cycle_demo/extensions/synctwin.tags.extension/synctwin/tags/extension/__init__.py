...
class SynctwinTagsExtensionExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[synctwin.tags.extension] SynctwinTagsExtensionExtension startup", flush=True)

    def on_shutdown(self):
        print("[synctwin.tags.extension] SynctwinTagsExtensionExtension shutdown", flush=True)
